# Backlog Demo — Pricing Master Simplified 2026

Target: **satu paket memiliki satu contoh visual yang unik dan benar-benar menunjukkan capability utamanya**.

Status:

- **Sumber tersedia** — project nyata sudah ada; pilih screenshot yang paling relevan.
- **Perlu akses internal** — perlu akun demo/staging untuk menampilkan dashboard atau workflow.
- **Perlu demo baru** — belum ada project yang cukup representatif.

Sebuah demo dianggap selesai setelah memiliki screenshot hero 16:9, satu capability pembeda, caption, URL bila live, dan data dummy yang aman.

## 1. Personal & Non-Profit

- [ ] **Personal Starter — Rp299.000**  
  Landing personal berisi profil, portfolio, kredibilitas, dan contact. Gunakan Happy Birthday Matt hanya sebagai referensi layout personal; **demo portfolio masih perlu dibuat**.
- [ ] **Personal Professional — Rp499.000+**  
...
- [ ] **Event Registration — Rp1.499.000+**  
...
- [ ] **Operational System — Rp5.000.000+**  
  Staff, customer, transaction, role, workflow, document, notification, audit, dan report. **Sumber tersedia:** Sahabat Qolbu; **perlu akses dashboard operasional**.

## 3. Business & Enterprise

- [ ] **Corporate Website — Rp2.500.000+**  
...
- [ ] **Custom Software & Enterprise Solution — Custom Quotation**  
  Buat architecture walkthrough yang menjelaskan ERP, SaaS, Marketplace, multi-tenant, multi-branch, security, infrastructure, dan SLA. **Perlu demo baru**.

## Urutan produksi

1. UMKM Starter.
2. E-Commerce Business.
3. Business System dashboard.
4. Operational System dashboard.
5. Corporate Business.
6. Event Website.
7. Event Registration.
8. Event Ticketing.
9. Wedding Guest Management dashboard.
10. Institution Pro dashboard.
11. E-Commerce Pro dashboard.
12. Government Website.
13. Digital Public Service.
14. Custom/Enterprise architecture walkthrough.

Jangan memakai homepage yang sama untuk beberapa paket. Jika satu project mempunyai banyak capability, ambil layar yang berbeda dan pastikan caption menjelaskan capability yang sedang dijual.
